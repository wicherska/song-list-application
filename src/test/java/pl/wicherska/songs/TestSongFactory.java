...
public class TestSongFactory {
    ...
    public static Song rAndBSong() {
        return new Song("Imported", "Jessie Reyez", "Before Love Came to Kill Us", Category.RNB, 6);
    }

    public static Song rAndBSong2() {
        return new Song("Reason", "11:11", "MOOD", Category.RNB, 11);
    }

    public static Song rAndBSong3() {
        return new Song("Earl Grey", "F.N.", "Earl Grey", Category.RNB, 7);
    }
}
